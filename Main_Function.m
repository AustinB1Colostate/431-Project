...
%% Main
% This function reads a CVS file with .m data file names. 
%Then searchs for the file in a designated folder. Then this data is loaded
%into the PanTompkins algorithm. 
function ECG_table = Main_Function(filename)
